PKG_DRIVERS += \
	rtl8180_515 rtl8187_515 \
	rtlwifi_515 rtlwifi-pci_515 rtlwifi-btcoexist_515 rtlwifi-usb_515 rtl8192c-common_515 \
	rtl8192ce_515 rtl8192se_515 rtl8192de_515 rtl8192cu_515 rtl8723bs_515 rtl8821ae_515 \
	rtl8xxxu_515 rtw88_515

config-$(call config_package,rtl8180_515) += RTL8180
config-$(call config_package,rtl8187_515) += RTL8187

config-$(call config_package,rtlwifi_515) += RTL_CARDS RTLWIFI
config-$(call config_package,rtlwifi-pci_515) += RTLWIFI_PCI
config-$(call config_package,rtlwifi-btcoexist_515) += RTLBTCOEXIST
config-$(call config_package,rtlwifi-usb_515) += RTLWIFI_USB
config-$(call config_package,rtl8192c-common_515) += RTL8192C_COMMON
config-$(call config_package,rtl8192ce_515) += RTL8192CE
config-$(call config_package,rtl8192se_515) += RTL8192SE
config-$(call config_package,rtl8192de_515) += RTL8192DE
config-$(call config_package,rtl8192cu_515) += RTL8192CU
config-$(call config_package,rtl8821ae_515) += RTL8821AE
config-$(CONFIG_PACKAGE_RTLWIFI_DEBUG) += RTLWIFI_DEBUG

config-$(call config_package,rtl8xxxu_515) += RTL8XXXU
config-y += RTL8XXXU_UNTESTED

config-$(call config_package,rtl8723bs_515) += RTL8723BS
config-y += STAGING

config-$(call config_package,rtw88_515) += RTW88 RTW88_CORE RTW88_PCI
...
define KernelPackage/rtl818x_515/Default
  ...
  DEPENDS+= +kmod-eeprom-93cx6 +kmod-mac80211_515
endef

define KernelPackage/rtl8180_515
  $(call KernelPackage/rtl818x_515/Default)
  DEPENDS+= @PCI_SUPPORT
  TITLE+= (RTL8180 PCI)
...
define KernelPackage/rtl8187_515
$(call KernelPackage/rtl818x_515/Default)
...
define KernelPackage/rtw88_515/config
...
define KernelPackage/rtw88_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=Realtek RTL8822BE/RTL8822CE/RTL8723DE
  DEPENDS+= @(PCI_SUPPORT) +kmod-mac80211_515 +@DRIVER_11AC_SUPPORT +@DRIVER_11N_SUPPORT
  FILES:=\
