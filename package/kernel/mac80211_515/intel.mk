PKG_DRIVERS += \
	iwl-legacy_515 iwl3945_515 iwl4965_515 iwlwifi_515 \
	libipw_515 ipw2100_515 ipw2200_515 \

config-$(call config_package,iwl-legacy_515) += IWLEGACY
config-$(call config_package,iwl3945_515) += IWL3945
config-$(call config_package,iwl4965_515) += IWL4965
config-$(call config_package,iwlwifi_515) += IWLWIFI IWLDVM IWLMVM
config-$(CONFIG_PACKAGE_IWLWIFI_DEBUG)+= IWLWIFI_DEBUG
config-$(CONFIG_PACKAGE_IWLWIFI_DEBUGFS)+= IWLWIFI_DEBUGFS

config-$(call config_package,libipw_515) += LIBIPW
config-$(call config_package,ipw2100_515) += IPW2100
config-$(call config_package,ipw2200_515) += IPW2200

define KernelPackage/iwlwifi_515
  $(call KernelPackage/mac80211_515/Default)
  DEPENDS:= +kmod-mac80211_515 +kmod-ptp @PCI_SUPPORT +@DRIVER_11N_SUPPORT +@DRIVER_11AC_SUPPORT
...
define KernelPackage/iwlwifi_515/description
...
define KernelPackage/iwlwifi_515/config
  if PACKAGE_kmod-iwlwifi_515
...
define KernelPackage/iwl-legacy_515
  $(call KernelPackage/mac80211_515/Default)
  DEPENDS:= +kmod-mac80211_515 @PCI_SUPPORT
  TITLE:=Intel legacy Wireless support
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/intel/iwlegacy/iwlegacy.ko
  AUTOLOAD:=$(call AutoProbe,iwlegacy)
endef

define KernelPackage/iwl-legacy_515/description
 iwl-legacy kernel module for legacy Intel wireless support
endef

define KernelPackage/iwl3945_515
  $(call KernelPackage/mac80211_515/Default)
  DEPENDS:= +kmod-mac80211_515 +kmod-iwl-legacy_515 +iwl3945-firmware
...
define KernelPackage/iwl3945_515/description
 iwl3945 kernel module for Intel 3945 support
endef

define KernelPackage/iwl4965_515
  $(call KernelPackage/mac80211_515/Default)
  DEPENDS:= +kmod-mac80211_515 +kmod-iwl-legacy_515 +@DRIVER_11N_SUPPORT +iwl4965-firmware
...
define KernelPackage/iwl4965_515/description
 iwl4965 kernel module for Intel 4965 support
endef


define KernelPackage/libipw_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=libipw for ipw2100 and ipw2200
  DEPENDS:=@PCI_SUPPORT +kmod-crypto-michael-mic +kmod-crypto-ecb +kmod-lib80211_515 +kmod-cfg80211_515 +@DRIVER_WEXT_SUPPORT @!BIG_ENDIAN
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/intel/ipw2x00/libipw.ko
  AUTOLOAD:=$(call AutoProbe,libipw)
endef

define KernelPackage/libipw_515/description
...
define KernelPackage/ipw2100_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=Intel IPW2100 driver
  DEPENDS:=@PCI_SUPPORT +kmod-libipw_515
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/intel/ipw2x00/ipw2100.ko
  AUTOLOAD:=$(call AutoProbe,ipw2100)
endef

define KernelPackage/ipw2100_515/description
...
define KernelPackage/ipw2200_515
  $(call KernelPackage/mac80211_515/Default)
...
define KernelPackage/ipw2200_515/description
 Kernel support for Intel IPW2200
 Includes:
 - ipw2200
endef

define KernelPackage/ipw2100_515/install
	$(INSTALL_DIR) $(1)/lib/firmware
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/ipw2100-$(IPW2100_VERSION)*.fw $(1)/lib/firmware
endef

define KernelPackage/ipw2200_515/install
	$(INSTALL_DIR) $(1)/lib/firmware
