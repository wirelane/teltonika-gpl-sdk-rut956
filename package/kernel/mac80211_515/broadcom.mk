PKG_DRIVERS += \
	b43_515 b43legacy_515 brcmsmac_515 brcmfmac_515 brcmutil_515
...
config-$(call config_package,b43_515) += B43
...
config-$(call config_package,b43legacy_515) += B43LEGACY
config-y += B43LEGACY_DMA_MODE

config-$(call config_package,brcmutil_515) += BRCMUTIL
config-$(call config_package,brcmsmac_515) += BRCMSMAC
config-$(call config_package,brcmfmac_515) += BRCMFMAC
...
define KernelPackage/b43_515
  ...
  DEPENDS += \
	@PCI_SUPPORT +kmod-mac80211_515 +kmod-lib-cordic \
	$(if $(CONFIG_PACKAGE_B43_USE_SSB),+kmod-ssb_515) \
...
define KernelPackage/b43_515/config

config PACKAGE_B43_USE_SSB_515
	select PACKAGE_kmod-ssb_515
	tristate
...
config PACKAGE_B43_USE_BCMA_515
...
define KernelPackage/b43_515/description
Kernel module for Broadcom 43xx wireless support (mac80211 stack) new
endef

define KernelPackage/b43legacy_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=Broadcom 43xx-legacy wireless support
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/b43
  KCONFIG:= \
  	CONFIG_HW_RANDOM=y
  DEPENDS+= +kmod-mac80211_515 +!(TARGET_bcm47xx||TARGET_bcm63xx):kmod-ssb @!TARGET_bcm47xx_mips74k
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/broadcom/b43legacy/b43legacy.ko
  AUTOLOAD:=$(call AutoProbe,b43legacy)
  MENU:=1
endef

define KernelPackage/b43legacy_515/description
Kernel module for Broadcom 43xx-legacy wireless support (mac80211 stack) new
endef


define KernelPackage/brcmutil_515
  $(call KernelPackage/mac80211_515/Default)
...
define KernelPackage/brcmutil_515/description
 This module contains some common parts needed by Broadcom Wireless drivers brcmsmac and brcmfmac.
endef

define KernelPackage/brcmutil_515/config
  if PACKAGE_kmod-brcmutil_515
...
define KernelPackage/brcmsmac_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=Broadcom IEEE802.11n PCIe SoftMAC WLAN driver
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/brcm80211
  DEPENDS+=@!TARGET_bcm47xx_legacy +kmod-mac80211_515 +@DRIVER_11N_SUPPORT +!TARGET_bcm47xx:kmod-bcma +kmod-lib-cordic +kmod-lib-crc8 +kmod-brcmutil_515 +!BRCMSMAC_USE_FW_FROM_WL:brcmsmac-firmware
  FILES:=$(PKG_BUILD_DIR)/drivers/net/wireless/broadcom/brcm80211/brcmsmac/brcmsmac.ko
  AUTOLOAD:=$(call AutoProbe,brcmsmac)
  MENU:=1
endef

define KernelPackage/brcmsmac_515/description
 Kernel module for Broadcom IEEE802.11n PCIe Wireless cards
endef

define KernelPackage/brcmsmac_515/config
  if PACKAGE_kmod-brcmsmac_515
...
define KernelPackage/brcmfmac_515
  $(call KernelPackage/mac80211_515/Default)
  TITLE:=Broadcom IEEE802.11n USB FullMAC WLAN driver
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/brcm80211
  DEPENDS+= @USB_SUPPORT +kmod-cfg80211_515 +@DRIVER_11N_SUPPORT +@DRIVER_11AC_SUPPORT \
  	+kmod-brcmutil_515 +BRCMFMAC_SDIO:kmod-mmc @!TARGET_uml \
...
define KernelPackage/brcmfmac_515/description
 Kernel module for Broadcom IEEE802.11n USB Wireless cards
endef

define KernelPackage/brcmfmac_515/config
  if PACKAGE_kmod-brcmfmac_515
