 ...
 */
	...
	#define CFG_UBOOT_SIZE		0x20000
	#define CFG_ART_SIZE		0
	#define CFG_FW_LEN		0xF40000
	#define	CFG_LOAD_ADDR		0xBC030000
#endif

#define CFG_MNF_SIZE		0x10000
#define CFG_FW_OFFSET		(CFG_UBOOT_SIZE + CFG_MNF_SIZE + CFG_ART_SIZE)
 ...
 * ==================================
 */
#define CONFIG_UPG_UBOOT_SIZE_BACKUP_HEX	CFG_UBOOT_SIZE
