define Device/teltonika_trb2m_common
	...
	HARDWARE/Physical_Interfaces/Atennas := 1 x SMA connector for LTE, 1 x SMA connector for GNSS
	HARDWARE/Physical_Interfaces/RS232 := $(HW_INTERFACE_RS232_4PIN)
	HARDWARE/Physical_Interfaces/RS485 := $(HW_INTERFACE_RS485_4PIN)
	HARDWARE/Input_Output/Input := 3 x Digital Input, 0 - 6 V detected as logic low, 8 - 30 V detected as logic high
	HARDWARE/Input_Output/Output := 3 x Digital Output, Open collector output, max output 30 V, 300 mA
